...
use crate::{Hash, Name, Repository};
...
/// let hgitignore  = Hash::from_str("96ef6c0b944e24fc22f51f18136cd62ffd5b0b8f").unwrap();
///
...
impl Tree {
    ...
    pub fn read(repository: &Repository, hash: &Hash) -> io::Result<Self> {
        ...
        loop {
            ...
            let hash = Hash::read_sha1(&mut reader)?;
...
pub struct Entry {
    ...
    /// A [Hash] referencing the contents of [Tree] or Blob
    ///
    /// [Hash]:         crate::Hash
    pub hash:           Hash,
